 ...
 */
final class Version20190524134430 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE mail (id INT AUTO_INCREMENT NOT NULL, sender_id INT DEFAULT NULL, receiver_id INT NOT NULL, advert_id INT DEFAULT NULL, firstname VARCHAR(100) NOT NULL, name VARCHAR(100) NOT NULL, phone VARCHAR(20) DEFAULT NULL, email_from VARCHAR(50) NOT NULL, template VARCHAR(100) NOT NULL, message LONGTEXT NOT NULL, subject VARCHAR(50) NOT NULL, INDEX IDX_5126AC48F624B39D (sender_id), INDEX IDX_5126AC48CD53EDB6 (receiver_id), INDEX IDX_5126AC48D07ECCB6 (advert_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE owner (id INT AUTO_INCREMENT NOT NULL, billing_address_id INT NOT NULL, user_id INT NOT NULL, company_name VARCHAR(50) DEFAULT NULL, company_number VARCHAR(20) DEFAULT NULL, firstname VARCHAR(30) NOT NULL, name VARCHAR(30) NOT NULL, phone_number VARCHAR(25) NOT NULL, UNIQUE INDEX UNIQ_CF60E67C79D0C0E4 (billing_address_id), UNIQUE INDEX UNIQ_CF60E67CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(50) NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, is_active TINYINT(1) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
